...
export const terminalMails: TerminalMail[] = [
  ...
  {
    id: "empty-face",
    level: "WESEN FILE // VISUAL ANOMALY",
    time: "17:03:18 ZULU",
    title: "[WESEN 파일] 빈 얼굴",
    title_en: "[WESEN FILE] The Empty Face",
    ...
    body: [
      "해당 WESEN 파일은 정상적인 문단 구조로 열람되지 않습니다.",
      "커서 위치에 따라 문서 조각이 밀려나며, 비어 있는 얼굴 형태를 발견하면 클릭하십시오.",
      "보고서 하단에는 접근자가 뒤돌아보지 말아야 한다는 반복 문구가 남아 있습니다.",
    ],
    body_en: [
      "This WESEN file cannot be viewed in a normal paragraph structure.",
