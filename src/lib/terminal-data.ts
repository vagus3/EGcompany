...
export const terminalObjects: TerminalObjectEntry[] = [
  ...
  },
  {
    ...
    description: [
      ...
      " ",
      "[확인된 구성 요소]",
      "두부: 중앙 처리 장치(CPU) 구조 / 상지: 메모리 모듈(RAM) 형태 / 흉부: 그래픽 처리 장치(GPU) 유사 구조 / 척추: 케이블 및 회로 형태",
      " ",
    ...
    containment_en: [
      "All search, viewing, and tracking activities related to WESEN-0101 are strictly prohibited on network-connected devices.",
      "Offline isolated terminals must be used when accessing entity-related documents.",
      "Entity-related data must be stored only on storage media completely separated from the internal network.",
    ],
    status_en: [
      "긴급 큐 격",
    ],
