          ...
          <div className="grid gap-8 md:grid-cols-[240px_1fr] lg:grid-cols-[280px_1fr] lg:gap-10">
            ...
            <div className="space-y-7">
              <div className="grid gap-6 sm:grid-cols-2">
                <InfoField label={t("info_label_name", lang)} value="EG Company" />
                <InfoField label={t("info_label_ceo", lang)} value="Director E.G." />
              </div>
              <InfoField label={t("info_label_brn", lang)} value="123-45-67890" />
              <div className="grid gap-6 sm:grid-cols-2">
                <InfoField label={t("info_label_phone", lang)} value="02-123-4567" />
                <InfoField label={t("info_label_fax", lang)} value="02-123-4568" />
              </div>
              <InfoField label={t("info_label_email", lang)} value="contact@egcompany.co.kr" />
              <hr className="border-gray-100" />
              <div>
                <p className="mb-2 text-[10px] tracking-widest text-gray-400 uppercase">
                  {t("info_label_address", lang)}
                </p>
                <p className="mb-4 text-sm text-black">{t("info_address", lang)}</p>
